...
-- Indexes for performance (IF NOT EXISTS requires MySQL 8.0+, use DROP/CREATE pattern)
DROP INDEX IF EXISTS idx_hotels_city ON hotels;
DROP INDEX IF EXISTS idx_hotels_price ON hotels;
DROP INDEX IF EXISTS idx_hotels_rating ON hotels;
DROP INDEX IF EXISTS idx_bookings_user ON bookings;
DROP INDEX IF EXISTS idx_bookings_hotel ON bookings;
DROP INDEX IF EXISTS idx_reviews_hotel ON reviews;
